...
version = rssgen.version.version_minor_str
# The full version, including alpha/beta/rc tags.
release = rssgen.version.version_full_str
...
latex_documents = [
    ('index', 'pyRssGen.tex', u'pyRssGen Documentation', u'Lars Kiesow',
     'manual'),
]
...
man_pages = [
    ('index', 'pyRssGen.tex', u'pyRssGen Documentation',
        [u'Lars Kiesow'], 1)
]
